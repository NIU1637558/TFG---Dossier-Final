...
def get_W2V_embeddings(balanced_data, text_cols):
...
###### 2. BERT embeddings #####
def get_BERT_embeddings(balanced_data, text_cols):
    ...
    # guardar embeddings
    # np.save('/fhome/amir/TFG/code/embedder/results/embeddings/AE1_BERT_embeddings.npy', all_text_embeddings)

    # # cargar embeddings
    all_text_embeddings = np.load('/fhome/amir/TFG/code/embedder/results/embeddings/AE1_BERT_embeddings.npy')
...
def main():
    ...
    if 'BERT' in name:
        text_embeddings, emb_model = get_BERT_embeddings(original_data, text_cols=['DESCRIPTION_trad', 'ITNDESCIMPACT_trad', 'REASONFORCHANGE_trad'])
    else:
        text_embeddings, emb_model = get_W2V_embeddings(original_data, text_cols=['DESCRIPTION_trad', 'ITNDESCIMPACT_trad', 'REASONFORCHANGE_trad'])
    ...
    wandb.save(os.path.join(os.path.dirname(__file__), 'codeAE2.py'))
    wandb.finish()
