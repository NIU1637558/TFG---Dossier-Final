...
def load_and_balance_data(extra):
    ...
    # Drop rows where PMCHGTYPE not in Preaprobado, NOP, Urgente, Informativo
    original_data = original_data[original_data['PMCHGTYPE'].isin(['Preaprobado', 'NOP', 'Urgente', 'Informativo','Emergencia (IOE)'])]
...
def main():
    ...
    # save code
    code_path = '/fhome/amir/TFG/code/classificators/DL/MLP_basic_HUMANonly.py'
