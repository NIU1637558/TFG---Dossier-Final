...
# import model
from model_arquitectres.models import MLP, MLPAttention1, MLP2
...
def single_training_loop(X, y, args, balanced_data, original_data, nepoch):
    ...
    model = MLPAttention1(X.shape[1]).to(device)
...
def main():
    ...
    # save code
    code_path = '/fhome/amir/TFG/code/classificators/DL/code/MLP_att1_HUMAN.py'
